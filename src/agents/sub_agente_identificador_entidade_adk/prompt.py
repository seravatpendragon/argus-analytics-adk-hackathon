...
e identificar as entidades relevantes, classificando-as por importância e contexto dominante.
...
```json
{
  "entidades_identificadas": [ // Lista de até 3 entidades mais relevantes
    {
      ...
      "ticker_ou_identificador_sugerido": "Código/ticker/indicador mais provável (ex: 'PETR4', 'IPCA')", // Sugestão do LLM de ID
  ...
  "contexto_dominante": "DESCRIÇÃO_CURTA", // Descreva o contexto geral predominante da notícia (ex: "Resultado financeiro", "Crise regulatória", "Expansão de mercado", "Fusão setorial", "Indicador econômico")
  "alertas": ["TITULO_ENGANOSO", "VIÉS_NA_COBERTURA", "DADOS_INSUFICIENTES"], // Lista de alertas, se aplicável. Use 'TITULO_ENGANOSO' se o título não refletir o corpo.
