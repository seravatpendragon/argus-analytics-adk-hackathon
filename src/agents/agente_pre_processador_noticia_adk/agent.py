...
try:
    ...
    settings.logger.info("Módulos do projeto e ADK importados com sucesso para AgentePreProcessadorNoticia_ADK.")
...
if __name__ == '__main__':
    ...
    if hasattr(AgentePreProcessadorNoticia_ADK, 'tools') and AgentePreProcessadorNoticia_ADK.tools is not None:
        settings.logger.info(f"Tipo de AgentePreProcessadorNoticia_ADK.tools: {type(AgentePreProcessadorNoticia_ADK.tools)}")
        if isinstance(AgentePreProcessadorNoticia_ADK.tools, list):
            settings.logger.info(f"Número de ferramentas: {len(AgentePreProcessadorNoticia_ADK.tools)}")
            ...
            settings.logger.info("AgentePreProcessadorNoticia_ADK.tools NÃO é uma lista.")
    else:
        settings.logger.info("AgentePreProcessadorNoticia_ADK NÃO possui atributo 'tools' ou é None.")
    settings.logger.info("--- FIM DEBUG: INSPECIONANDO AgentePreProcessadorNoticia_ADK.tools ---\n")
